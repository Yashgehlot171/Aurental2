            ...
            <View>
                ...
                <View style={{
                    ...
                    {navigationState.routes.map((route, index) => {
                        ...
                        else if (route.routeName === 'HistoryD') {
                            return (
                                <Tab
                                    title={'History'}
                        ...
                        else if (route.routeName === 'VehicleD') {
                            return (
                                <Tab
                                title={'Vehicle'}

                                activeImage={require('../../assets/icon/menu-vehicleActive.png')}
                                unactiveImage={require('../../assets/icon/menu-vehicleInactive.png')}
                                onPress={() => {
                                    // this.props.refreshMore();
                                    navigation.navigate(route.routeName)
                                }}
                        ...
                        else  if (route.routeName === 'NotificationD') {
                            return (
                                <Tab
                                title={'Notification'}
