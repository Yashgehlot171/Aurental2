...
centerComponent={
    <Text style={{ width: '100%', color: Colors.dark_gry, fontSize:20, textAlign: 'center', marginTop: 5, marginLeft: -5, height: 40 }}>About Us</Text>
...
<WebView source={{ uri: 'http://ec2-54-251-142-179.ap-southeast-1.compute.amazonaws.com:6060/content/about_us.html' }} />
   </View>
  );
};
