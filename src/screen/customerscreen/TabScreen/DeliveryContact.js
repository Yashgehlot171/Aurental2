  ...
  return (
    <View style={{flex:1}}>
     <SafeAreaView style={{flex:1,backgroundColor:'#fff'}}/>
       <ScrollView style={{}}>
         <Text style={{textAlign:"center", fontSize:22, marginTop:25, marginBottom:0, fontWeight:'bold'}}>Item has been sent.</Text>
         <Text style={{textAlign:"center", fontSize:10, marginTop:5, marginBottom:50, color:"gray"}}>Confirm your delivery by signing delow</Text>
         ...
         <Text style={{color:"gray", marginLeft:20, fontSize:12, marginBottom:20}}>Lorem ipsum dolor sit amet,  consectetur  adipiscing elit.
          ...
          <TouchableOpacity style={{width:"70%", backgroundColor:"#296C94", height:"7%", alignSelf:"center", borderRadius:5}}>
